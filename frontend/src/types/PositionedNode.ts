...
abstract class PositionedNode extends BaseNode {
	...
	super(stroke_color, width, height, scaleX, scaleY)
	this.x = x
	this.y = y
    }

    protected has_changes = (position?: {x: number, y: number}, dimensions?: {width?: number, height?: number, radius?: number}): boolean => {
